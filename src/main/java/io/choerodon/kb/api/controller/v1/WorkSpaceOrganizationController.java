...
public class WorkSpaceOrganizationController {
    ...
    public ResponseEntity<WorkSpaceInfoVO> createWorkSpaceAndPage(@ApiParam(value = "组织id", required = true)
        ...
        return new ResponseEntity<>(workSpaceService.createWorkSpaceAndPage(organizationId, null, pageCreateVO, false), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity removeWorkSpaceAndPage(@ApiParam(value = "组织id", required = true)
                                                 ...
                                                 @ApiParam(value = "工作空间目录id", required = true)
                                                 @PathVariable @Encrypt Long id) {
        workSpaceService.moveToRecycle(organizationId, null, id, true);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    ...
    public ResponseEntity removeWorkSpaceAndPageMyWorkSpace(@ApiParam(value = "组织id", required = true)
                                                            ...
                                                            @ApiParam(value = "工作空间目录id", required = true)
                                                            @PathVariable @Encrypt Long id) {
        workSpaceService.moveToRecycle(organizationId, null, id, false);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<Page<WorkSpaceRecentInfoVO>> recentUpdateList(@ApiParam(value = "组织id", required = true)
        ...
        //组织层设置成permissionLogin=true，因此需要单独校验权限
        workSpaceService.checkOrganizationPermission(organizationId);
        return new ResponseEntity<>(workSpaceService.recentUpdateList(organizationId, null, baseId, pageRequest), HttpStatus.OK);
    }
    ...
    public ResponseEntity<WorkSpaceInfoVO> clonePage(@ApiParam(value = "组织id", required = true)
        ...
        return new ResponseEntity<>(workSpaceService.clonePage(organizationId, null, workSpaceId, parentId), HttpStatus.OK);
    }
