...
public class WorkSpaceProjectController {
    ...
    public ResponseEntity<Page<WorkSpaceRecentInfoVO>> recentUpdateList(@ApiParam(value = "项目id", required = true)
        ...
        return new ResponseEntity<>(workSpaceService.recentUpdateList(organizationId, projectId, baseId, pageRequest), HttpStatus.OK);
    }
    ...
    public ResponseEntity<FileSimpleDTO> uploadMultipartFileWithMD5(
            @ApiParam(value = "租户ID", required = true) @RequestParam Long organizationId,
