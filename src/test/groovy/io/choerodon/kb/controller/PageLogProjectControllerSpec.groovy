...
@ActiveProfiles("test")
@Stepwise
class PageLogProjectControllerSpec extends Specification {
    ...
    def url = '/v1/projects/{project_id}/page_log'
    ...
    def "listByPageId"() {
        ...
        def entity = restTemplate.exchange(url + "/{page_id}?organizationId=" + organizationId, HttpMethod.GET, null, typeRef, projectId, workSpaceInfo.pageInfo.id)
