...
@ActiveProfiles("test")
@Stepwise
class UserSettingOrganizationControllerSpec extends Specification {
    ...
    def url = '/v1/organizations/{organization_id}/user_setting'
    ...
    def "createOrUpdate"() {
        ...
        def entity = restTemplate.exchange(url, HttpMethod.POST, httpEntity, ResponseEntity, organizationId)
