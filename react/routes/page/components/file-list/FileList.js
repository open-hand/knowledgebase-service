...
function FileList(props) {
  ...
  const handlePreviewClick = (service, name, fileUrl) => {
    ...
    history.push(`/knowledge/preview?type=${urlParams.type}&id=${urlParams.id}&name=${encodeURIComponent(urlParams.name)}&organizationId=${urlParams.organizationId}&fileService=${service}&fileName=${name}&fileUrl=${fileUrl}`);
  };
