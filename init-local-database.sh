...
java -Dspring.datasource.url="jdbc:mysql://localhost/knowledgebase_service?useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true" \
